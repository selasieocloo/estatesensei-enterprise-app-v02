                ...
                <div className="grid w-full auto-cols-fr grid-cols-1 items-center justify-center gap-12 md:grid-cols-2 md:gap-10 lg:gap-x-20">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <blockquote className="text-xl font-bold md:text-2xl">
                      "Thanks to EstateSensei, my relocation to Kenya was
                      seamless and stress-free! Their guidance made all the
                      difference in finding the perfect home."
                    </blockquote>
                    <div className="mt-6 flex flex-nowrap items-center gap-5 md:mt-8">
                      <div>
                        <p className="font-semibold">James Mwangi</p>
                        <p>Relocation Consultant</p>
                      </div>

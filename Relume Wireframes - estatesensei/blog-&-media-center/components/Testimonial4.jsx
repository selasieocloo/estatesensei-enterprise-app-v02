      ...
      <div className="container">
        <div className="mx-auto w-full max-w-lg text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "The insights I gained from EstateSensei's resources have been
            invaluable in navigating the African real estate market. Their
            expertise truly sets them apart!"
          </blockquote>
